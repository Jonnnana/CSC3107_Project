...
3.  Another library to help with interactivity would be *highcharter* library which provides a simple interface to generate sophisticated and highly customizable charts.
