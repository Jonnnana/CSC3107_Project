...
-	The use of heatmap design allows the data to be visually intuitive, enabling the users to determine changes in inflation rate more efficiently.
-	The heatmap has organized the information in different categories which allow users to compare the impact of inflation towards different domains over the months. 
